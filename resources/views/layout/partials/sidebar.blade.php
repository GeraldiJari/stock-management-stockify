    ...
    <div class="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto">
      <div class="flex-1 px-3 space-y-1 bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
        <ul class="pb-2 space-y-2">
          ...
          <li>
            <a href="{{ url('/admin/dashboard') }}" class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700">
          ...
          <li>
            ...
            <ul id="dropdown-crud" class="space-y-2 py-2 {{ Request::is('crud/*') ? 'block' : 'hidden' }}">
              <li>
                <a href="{{ route('product.index') }}" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700
                  {{ Request::is('products/index') ? 'bg-gray-200 dark:bg-gray-700' : '' }}">
                  Products
                </a>
              </li>
              <li>
                <a href="{{ route('categories.list') }}" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700
                  {{ Request::is('categories/list') ? 'bg-gray-200 dark:bg-gray-700' : '' }}">
                  Categories
                </a>
              </li>
              <li>
                <a href="{{ route('user.tes') }}" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700
                {{ Request::is('tes/daftar') ? 'bg-gray-200 dark:bg-gray-700' : '' }}">
                Users
              </a>
              </li>
            </ul>
          ...
          <li>
            <a href="{{ url('suppliers/list') }}" class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700 {{ $page_slug == 'settings' ? 'bg-gray-100 dark:bg-gray-700' : '' }}">
              ...
              <span class="ml-3" sidebar-toggle-item>Suppliers</span>
          </a>
          </li>
          <li>
            <a href="{{ url('stoks/list') }}" class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700 {{ $page_slug == 'settings' ? 'bg-gray-100 dark:bg-gray-700' : '' }}">
              <svg class="w-6 h-6  text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
          ...
          @if (Auth::user()->role == 'manajer_gudang')
            ...
            @include('layout.partials.sidebar_manajer');
          
          @endif

          @if (Auth::user()->role == 'staff_gudang')

            @include('layout.partials.sidebar_staff');
