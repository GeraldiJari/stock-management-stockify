            ...
            <div class="overflow-hidden shadow">
                <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                        @foreach($attribute as $categories)
                        <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                            <td class="flex items-center p-4 mr-12 space-x-6 whitespace-nowrap">
                                {{-- <img class="w-10 h-10 rounded-full" src="{{ asset('static/images/users/'. $user['avatar']) }}" alt="avatar"> --}}
                                <div class="text-sm font-normal text-gray-500 dark:text-gray-400">
                                    <div class="text-base font-semibold text-gray-900 dark:text-white">{{ $categories['name'] }}</div>
                                    <div class="text-sm font-normal text-gray-500 dark:text-gray-400">Name-Product : {{ $categories['product_name'] }} | ID : {{ $categories['id'] }}</div>
                                </div>
                            </td>
                            <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ $categories['value'] }}</td>
                            <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ $categories['created_at']->diffForHumans()}}</td>
                            <td class="p-4 space-x-2 whitespace-nowrap">                            
                                <a href="{{ url('products/attribute/edit/'.$categories->id) }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline" data-modal-toggle="edit-user-modal" data-user-id="{{ $categories->id }}">Edit</a>
                                {{-- <a href="#" data-toggle="modal" data-target="#ModalEdit" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit</a> --}}
                                <script>
                                 document.querySelectorAll('[data-modal-toggle="delete-user-modal"]').forEach(button => {
                ...
                <form action="#">
                  ...
                  <div class="grid grid-cols-6 gap-6">
                     <div class="col-span-6 sm:col-span-3">
                         ...
                         <input type="text" name="name" value="{{ $user->name }}" id="name" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5" required>
                     </div>
                     <div class="col-span-6 sm:col-span-3">
                         <label for="email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Email</label>
                         <input type="email" name="email" id="email" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5" required>
                     </div>
                     <div class="col-span-6 sm:col-span-3">
    ...
    <div class="relative w-full h-full max-w-md px-4 md:h-auto">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
            ...
            <div class="p-6 pt-0 text-center">
                ...
                <form action="{{ route('user.delete', 'userid') }}" method="POST" id="delete-user-form">
                  @csrf
                  @method('DELETE')
                  ...
                  <button type="button" class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600" data-modal-toggle="delete-user-modal">
                      No, cancel
                  </button>
              </form>
                </form>
