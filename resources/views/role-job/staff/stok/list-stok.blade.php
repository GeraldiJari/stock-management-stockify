...
<div class="p-4 bg-white block sm:flex items-center justify-between border-b border-gray-200 lg:mt-1.5 dark:bg-gray-800 dark:border-gray-700">
    <div class="w-full mb-1">
        <div class="mb-4">
            ...
            <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Confirm Stock In or Out</h1>
        </div>
        <div class="sm:flex">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                        ...
                        <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                            <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                <a href="{{ url('dashboard/activities/request/'.$stok->id) }}" class="font-semibold text-blue-600 dark:text-blue-500">
                                    {{ $stok->product->name }}
                                </a>
                            </td>
                            <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ $stok->type }}</td>
                            <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ $stok->quantity ?? 'N/A' }}</td>
                
                            <!-- Tanggal Transaksi -->
                            <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                {{ $stok->created_at->format('Y-m-d') }}
                            </td>
                            <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                {{ $stok->updated_at->format('Y-m-d H:i:s') }} <!-- Date Out -->
                            </td>
                            ...
                            <td class="p-4 space-x-2 whitespace-nowrap">
                                <a href="{{ url('dashboard/activities/request/'.$stok->id) }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">
                                    Edit
                                </a>
                            </td>
                        </tr>
