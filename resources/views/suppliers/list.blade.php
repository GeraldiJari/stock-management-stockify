                        ...
                        <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                            <td class="flex items-center p-4 mr-12 space-x-6 whitespace-nowrap">
                                ...
                                <div class="text-sm font-normal text-gray-500 dark:text-gray-400">
                                    ...
                                    <div class="text-sm font-normal text-gray-500 dark:text-gray-400">Address : {{ $value['address'] }}</div>
                                </div>
                            </td>
                            ...
                            <td class="p-4 space-x-2 whitespace-nowrap">                            
                                <a href="{{ url('suppliers/edit/'.$value->id) }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline" data-modal-toggle="edit-user-modal" data-user-id="{{ $value->id }}">Edit</a>
