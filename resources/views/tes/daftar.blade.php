                ...
                <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                        ...
                        <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                            ...
                            <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ $user['created_at']->diffForHumans()}}</td>
                            ...
                            <td class="p-4 space-x-2 whitespace-nowrap">
                              <script>
                                 function openEditModal(userId) {
                                    $.ajax({
                                       ...
                                       success: function(response) {
                                             ...
                                             $('#edit-user-modal').removeClass('hidden'); // Tampilkan modal
                                       },
                                       error: function(xhr) {
                                ...
                                <a href="{{ url('tes/edit/'.$user->id) }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline" data-modal-toggle="edit-user-modal" data-user-id="{{ $user->id }}">Edit</a>
